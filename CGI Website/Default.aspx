...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
            ...
            <div class="bgimg">
            <div class="img-container"><asp:Image ID="imgg1" runat="server" src="./images/counter-first-icon.png" alt="CGI Logo" CssClass="imgs" /><span class="no">500</span> </div>
            <div class="img-container"><asp:Image ID="imgg2" runat="server" src="./images/counter-second-icon.png" alt="CGI Logo" CssClass="imgs" /><span class="no">85</span> </div>
            <div class="img-container"><asp:Image ID="Imgg3" runat="server" src="./images/counter-third-icon.png" alt="CGI Logo" CssClass="imgs" /><span class="no">7896</span> </div>
            <div class="img-container"><asp:Image ID="imgg4" runat="server" src="./images/counter-fourth-icon.png" alt="CGI Logo" CssClass="imgs" /><span class="no">600</span> </div>
            </div>
