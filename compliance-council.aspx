<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="compliance-council.aspx.cs" Inherits="compliance_council" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <div class=" bgimg abtimg">
                <div class="fl"><span>CGI { Compliance Council }</span></div>
    ...
    <div class="abt">
                ...
                <div>
                <asp:Image ID="Image1" runat="server" src="./images/c-council.jpg" AlternateText="Comliance Council Image" CssClass="ccimg"/>
                </div>
            </div>
